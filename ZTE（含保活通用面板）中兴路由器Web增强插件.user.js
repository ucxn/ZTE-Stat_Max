...
(function() {
    ...
    function injectGegeMenu() {
        ...
        if (liTag) {
            ...
            let vroutemeta = '哥哥科技面板';
            let _vM = [0x54e3, 0x54e3, 0x79d7, 0x6286, 0x9764, 0x6779];
            let _k = ['\x74\x65\x78\x74\x43\x6f\x6e\x74\x65\x6e\x74', '\x6d\x61\x70', '\x53\x74\x72\x69\x6e\x67', '\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65', '\x6c\x65\x6e\x67\x74\x68', '\x6a\x6f\x69\x6e'];
            if (textSpan) textSpan[_k[0]] = _vM[_k[1]](_x => window[_k[2]][_k[3]](_x ^ vroutemeta[_k[4]]))[_k[5]]('');
