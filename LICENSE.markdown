...
1. **Adaptive Public License 1.0 (APL-1.0)**; or
2. **Sustainable Use License 1.0 (SUL-1.0) AND PolyForm Noncommercial License 1.0.0**.

In SPDX notation:

`SPDX-License-Identifier: APL-1.0 OR (SUL-1.0 AND PolyForm-Noncommercial-1.0.0)`
