...
(function() {
    ...
    const CONFIG = {
        ...
        lanRefreshInterval: 2, // 【新增】LAN口刷新时间(秒)，用于精准补偿0到唤醒时的瞬时流量
        portMap: {
            "eth1": "网口 1",
            "eth2": "网口 2",
            "eth3": "网口 3",
...
hpU=0,hpD=0,
abU=0,abD=0;
for(let k in S.cls){let s=S.cls[k]||{};LUp+=s.intUp;LDn+=s.intDn;hpU+=Math.max(0,(s.lU||0)-(s.uB||0)-(s.oU||0));hpD+=Math.max(0,(s.lD||0)-(s.dB||0)-(s.oD||0));}
