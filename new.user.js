...
(function() {
    ...
    appendChild(st);window.gegeRenderedMacs=new Set();async function rSD(pWT=null,sT=null){if(
        ...
        cM);window.gegeForceUIRedraw=!1;}let gDt=(S.lt!==0)?(n-S.lt)/1000:0;if(S.wLT===undefined){S.wLT=n;}else if(cWU!==S.wInstUp||cWD!==S.wInstDn){let wDt=n-S.wLT;S.wTotUp+=(S.wInstUp+cWU)*wDt/2000;S.wTotDn+=(S.wInstDn+cWD)*wDt/2000;S.wLT=n;}for(let m in cI){let cC=cI[m];if(!S.cls[m]){S.cls[m]={upR:cC.upRate,dnR:cC.dnRate,lUT:n,intUp:0,intDn:0,uB:CONFIG.readSaveData===1?0:cC.offUp,dB:CONFIG.readSaveData===1?0:cC.offDn,lU:cC.offUp,lD:cC.offDn,aR:!1,dpU:0,dpD:0,oU:CONFIG.readSaveData===1?cC.offUp:0,oD:CONFIG.readSaveData===1?cC.offDn:0};}let cS=S.cls[m],dU=cC.offUp-cS.lU,dD=cC.offDn-cS.lD;if(dU<0||dD<0){if(dU<0){cS.uB+=dU;cS.dpU=cS.lU;}if(dD<0){cS.dB+=dD;cS.dpD=cS.lD;}cS.aR=!0;}else if(cS.aR){if(dD>2516582400||dU>671088640||(cS.dpD&&dD>=cS.dpD)||(cS.dpU&&dU>=cS.dpU)){cS.uB+=dU;cS.dB+=dD;cS.aR=!1;cS.dpU=0;cS.dpD=0;}}if(cS.lOS!==cC.onSec){cS.onS=cC.onSec;cS.lOS=cC.onSec;}else{cS.onS=(cS.onS||cC.onSec||0)+gDt;}if(cC.upRate!==cS.upR||cC.dnRate!==cS.dnR){let ms=n-cS.lUT;cS.intUp+=(cS.upR+cC.upRate)*ms/2000;cS.intDn+=(cS.dnR+cC.dnRate)*ms/2000;cS.upR=cC.upRate;cS.dnR=cC.dnRate;cS.lUT=n;}cS.lU=cC.offUp;cS.lD=cC.offDn;}S.lt=n;S.wInstUp=cWU;S.wInstDn=cWD;rUI(cWU,cWD,cSU,cSD,cI);}catch(e){}finally{isF=!1;}}function rUI(wU,wD,sU,sD,cI){let tOU=
