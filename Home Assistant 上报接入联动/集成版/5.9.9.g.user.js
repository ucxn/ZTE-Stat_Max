...
(function() {
    ...
    appendChild(st);window.gegeRenderedMacs=new Set();async function rSD(pWT=null,sT=null){if(
        ...
        parseFloat(d.UpThroughput)||0)*8000,dT=(parseFloat(d.DownThroughput)||0)*8000;let bN=
                                                                                             d.AliasName||d.HostName||d.DisplayedPictureName||"";cI[m]={upRate:u,dnRate:dn,iface:d.Interface||"",offUp:uT,offDn:dT,onSec:parseInt(d.OnlineDuration||d.OnlineTime||d.LeaseTime||0),name:bN};cSU+=u;cSD+=dn;}});let ol=document.getElementById('gege-global-overlay'),cM=Object.keys(
...
GM_setValue('ha_snapshot',{timestamp:Date.now(),global:{wan_up:S.wTotUp,wan_down:S.wTotDn,lan_high_up:hpU,lan_high_down:hpD,lan_off_up:abU,lan_off_down:abD},devices:cln});
