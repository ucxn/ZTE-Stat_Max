// ==UserScript==
// @name         中兴路由器(ZTE) 赛博极客增强版 (V7.0 对齐终极版)
...
(function() {
    ...
    style.innerHTML = `
        ...
        .config-item .dev-intro { flex: 1; display: flex !important; flex-direction: column; justify-content: flex-start; min-height: 100px; }
        ...
        /* 核心对齐法：推到底部 */
        .gege-up-box, .gege-down-box { margin-top: auto !important; width: 95%; }
        ...
        deviceItems.forEach(item => {
            ...
            if (speed) {
                ...
                if (!enh) {
                    ...
                    enh.innerHTML = `<div class="zte-bar-wrap zte-bar-up"><span>🔼 <small class="v-val"></small></span><span class="v-pct"></span></div><div class="zte-bar-wrap zte-bar-down"><span>🔽 <small class="v-val"></small></span><span class="v-pct"></span></div>`;
