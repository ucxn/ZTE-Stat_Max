...
(function() {
    ...
    style.innerHTML = `
        ...
        /* ====== 面板UI终极重构：强杀所有间隙灰底，强制全白圆角矩形包围 ====== */

        /* 给最外层的总控容器强加白底、圆角和外边框 */
        .gege-list-container {
            ...
            overflow: hidden !important; /* 确保子元素圆角不溢出 */
        }
        ...
        /* 内部设备条目背景强行继承白色，剥离自带 margin 防止露馅 */
        .gege-list-item {
            background-color: #ffffff !important;
            border-bottom: 1px solid #f0f0f0 !important;
            padding: 15px 10px !important;
            margin: 0 !important; /* 核心：杀死 margin，杜绝灰色底透出 */
    ...
    function injectGegeMenu() {
        ...
        if (liTag) {
            ...
            // 核心修改点：调整小火箭的边距和宽度，让后面的文字往左边靠紧，适配窄屏显示
            let emojiSpan = document.createElement('span');
            emojiSpan.textContent = '🚀';
            emojiSpan.style.cssText = 'font-size: 20px; margin-right: 0px; vertical-align: middle; display: inline-block; width: 20px; text-align: center;';
